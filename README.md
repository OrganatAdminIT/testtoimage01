...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/testtoimage01)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/testtoimage01
```

A live public deployment of this template is available at [https://testtoimage01.templates.workers.dev](https://testtoimage01.templates.workers.dev)
